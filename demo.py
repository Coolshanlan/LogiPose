...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-path', default='checkpoint\checkpoint_iter_370000.pth',
                        type=str, required=False, help='path to the checkpoint')
